...
let myFamily = ["Jenni", "Junne", "Ami", "Liam"]

let sortedCollection1 = myFamily.sorted(by: forwards)
...
let sortedCollection2 = myFamily.sorted { (name1, name2) -> Bool in
    return name1 < name2
}
...
let sortedCollection3 = myFamily.sorted(by: <)
